...
class myImages(QWidget):
    colormap_dict_cm = {0: 'viridis', 1: 'plasma', 2: 'inferno', 3: 'magma', 4: 'cividis', 5: 'Greys',
    ...
    colormap_dict_name = {0: 'viridis', 1: 'plasma', 2: 'inferno', 3: 'magma', 4: 'cividis', 5: 'Greys',
                        ...
                        75: 'cubehelix', 76: 'brg', 77: 'gist_rainbow', 78: 'rainbow', 79: 'jet', 80: 'turbo',
                        81: 'nipy_spectral', 82: 'gist_ncar'}
    cmDictCmapColors = {'Perceptually Uniform Sequential': [
                     cm.viridis.colors, cm.plasma.colors, cm.inferno.colors, cm.magma.colors, cm.cividis.colors],
                 'Sequential': [
                     pg.colormap.get('Greys', source='matplotlib').getColors(mode=pg.ColorMap.BYTE), pg.colormap.get('Purples', source='matplotlib').getColors(mode=pg.ColorMap.BYTE),
                     pg.colormap.get('Blues', source='matplotlib').getColors(mode=pg.ColorMap.BYTE), pg.colormap.get('Greens', source='matplotlib').getColors(mode=pg.ColorMap.BYTE),
                     pg.colormap.get('Oranges', source='matplotlib').getColors(mode=pg.ColorMap.BYTE), pg.colormap.get('Reds', source='matplotlib').getColors(mode=pg.ColorMap.BYTE),
                     pg.colormap.get('YlOrBr', source='matplotlib').getColors(mode=pg.ColorMap.BYTE), pg.colormap.get('YlOrRd', source='matplotlib').getColors(mode=pg.ColorMap.BYTE),
                     pg.colormap.get('OrRd', source='matplotlib').getColors(mode=pg.ColorMap.BYTE), pg.colormap.get('PuRd', source='matplotlib').getColors(mode=pg.ColorMap.BYTE),
                     pg.colormap.get('RdPu', source='matplotlib').getColors(mode=pg.ColorMap.BYTE), pg.colormap.get('BuPu', source='matplotlib').getColors(mode=pg.ColorMap.BYTE),
                     pg.colormap.get('RdPu', source='matplotlib').getColors(mode=pg.ColorMap.BYTE), pg.colormap.get('PuBu', source='matplotlib').getColors(mode=pg.ColorMap.BYTE),
                     pg.colormap.get('YlGnBu', source='matplotlib').getColors(mode=pg.ColorMap.BYTE), pg.colormap.get('PuBuGn', source='matplotlib').getColors(mode=pg.ColorMap.BYTE),
                     pg.colormap.get('BuGn', source='matplotlib').getColors(mode=pg.ColorMap.BYTE), pg.colormap.get('YlGn', source='matplotlib').getColors(mode=pg.ColorMap.BYTE)],
                 'Sequential (2)': [
                     pg.colormap.get('binary', source='matplotlib').getColors(mode=pg.ColorMap.BYTE), pg.colormap.get('gist_yarg', source='matplotlib').getColors(mode=pg.ColorMap.BYTE),
                     pg.colormap.get('gist_gray', source='matplotlib').getColors(mode=pg.ColorMap.BYTE), pg.colormap.get('gray', source='matplotlib').getColors(mode=pg.ColorMap.BYTE),
                     pg.colormap.get('bone', source='matplotlib').getColors(mode=pg.ColorMap.BYTE), pg.colormap.get('pink', source='matplotlib').getColors(mode=pg.ColorMap.BYTE),
                     pg.colormap.get('spring', source='matplotlib').getColors(mode=pg.ColorMap.BYTE), pg.colormap.get('summer', source='matplotlib').getColors(mode=pg.ColorMap.BYTE),
                     pg.colormap.get('autumn', source='matplotlib').getColors(mode=pg.ColorMap.BYTE), pg.colormap.get('winter', source='matplotlib').getColors(mode=pg.ColorMap.BYTE),
                     pg.colormap.get('cool', source='matplotlib').getColors(mode=pg.ColorMap.BYTE), pg.colormap.get('Wistia', source='matplotlib').getColors(mode=pg.ColorMap.BYTE),
                     pg.colormap.get('hot', source='matplotlib').getColors(mode=pg.ColorMap.BYTE), pg.colormap.get('afmhot', source='matplotlib').getColors(mode=pg.ColorMap.BYTE),
                     pg.colormap.get('gist_heat', source='matplotlib').getColors(mode=pg.ColorMap.BYTE), pg.colormap.get('copper', source='matplotlib').getColors(mode=pg.ColorMap.BYTE)],
                 'Diverging': [
                     pg.colormap.get('PiYG', source='matplotlib').getColors(mode=pg.ColorMap.BYTE), pg.colormap.get('PRGn', source='matplotlib').getColors(mode=pg.ColorMap.BYTE),
                     pg.colormap.get('BrBG', source='matplotlib').getColors(mode=pg.ColorMap.BYTE), pg.colormap.get('PuOr', source='matplotlib').getColors(mode=pg.ColorMap.BYTE),
                     pg.colormap.get('RdGy', source='matplotlib').getColors(mode=pg.ColorMap.BYTE), pg.colormap.get('RdBu', source='matplotlib').getColors(mode=pg.ColorMap.BYTE),
                     pg.colormap.get('RdYlBu', source='matplotlib').getColors(mode=pg.ColorMap.BYTE), pg.colormap.get('RdYlGn', source='matplotlib').getColors(mode=pg.ColorMap.BYTE),
                     pg.colormap.get('Spectral', source='matplotlib').getColors(mode=pg.ColorMap.BYTE), pg.colormap.get('coolwarm', source='matplotlib').getColors(mode=pg.ColorMap.BYTE),
                     pg.colormap.get('bwr', source='matplotlib').getColors(mode=pg.ColorMap.BYTE), pg.colormap.get('seismic', source='matplotlib').getColors(mode=pg.ColorMap.BYTE)],
                 'Cyclic': [
                     pg.colormap.get('twilight', source='matplotlib').getColors(mode=pg.ColorMap.BYTE), pg.colormap.get('twilight_shifted', source='matplotlib').getColors(mode=pg.ColorMap.BYTE),
                     pg.colormap.get('hsv', source='matplotlib').getColors(mode=pg.ColorMap.BYTE)],
                 'Qualitative': [
                     cm.Pastel1.colors, cm.Pastel2.colors, cm.Paired.colors, cm.Accent.colors,
                     cm.Dark2.colors, cm.Set1.colors, cm.Set2.colors, cm.Set3.colors,
                     cm.tab10.colors, cm.tab20.colors, cm.tab20b.colors, cm.tab20c.colors],
                 'Miscellaneous': [
                     pg.colormap.get('flag', source='matplotlib').getColors(mode=pg.ColorMap.BYTE), pg.colormap.get('prism', source='matplotlib').getColors(mode=pg.ColorMap.BYTE),
                     pg.colormap.get('ocean', source='matplotlib').getColors(mode=pg.ColorMap.BYTE), pg.colormap.get('gist_earth', source='matplotlib').getColors(mode=pg.ColorMap.BYTE),
                     pg.colormap.get('terrain', source='matplotlib').getColors(mode=pg.ColorMap.BYTE), pg.colormap.get('gist_stern', source='matplotlib').getColors(mode=pg.ColorMap.BYTE),
                     pg.colormap.get('gnuplot', source='matplotlib').getColors(mode=pg.ColorMap.BYTE), pg.colormap.get('gnuplot2', source='matplotlib').getColors(mode=pg.ColorMap.BYTE),
                     pg.colormap.get('CMRmap', source='matplotlib').getColors(mode=pg.ColorMap.BYTE), pg.colormap.get('cubehelix', source='matplotlib').getColors(mode=pg.ColorMap.BYTE),
                     pg.colormap.get('brg', source='matplotlib').getColors(mode=pg.ColorMap.BYTE),
                     pg.colormap.get('gist_rainbow', source='matplotlib').getColors(mode=pg.ColorMap.BYTE), pg.colormap.get('rainbow', source='matplotlib').getColors(mode=pg.ColorMap.BYTE),
                     pg.colormap.get('jet', source='matplotlib').getColors(mode=pg.ColorMap.BYTE),pg.colormap.get('turbo', source='matplotlib').getColors(mode=pg.ColorMap.BYTE),
                     pg.colormap.get('nipy_spectral', source='matplotlib').getColors(mode=pg.ColorMap.BYTE), pg.colormap.get('gist_ncar', source='matplotlib').getColors(mode=pg.ColorMap.BYTE)]}
    cmDictCmap = {'Perceptually Uniform Sequential': [
                     pg.colormap.get('viridis', source='matplotlib'), pg.colormap.get('plasma', source='matplotlib'),
                     pg.colormap.get('inferno', source='matplotlib'), pg.colormap.get('magma', source='matplotlib'),
                     pg.colormap.get('cividis', source='matplotlib')],
                 'Sequential': [
                     pg.colormap.get('Greys', source='matplotlib'), pg.colormap.get('Purples', source='matplotlib'),
                     pg.colormap.get('Blues', source='matplotlib'), pg.colormap.get('Greens', source='matplotlib'),
                     pg.colormap.get('Oranges', source='matplotlib'), pg.colormap.get('Reds', source='matplotlib'),
                     pg.colormap.get('YlOrBr', source='matplotlib'), pg.colormap.get('YlOrRd', source='matplotlib'),
                     pg.colormap.get('OrRd', source='matplotlib'), pg.colormap.get('PuRd', source='matplotlib'),
                     pg.colormap.get('RdPu', source='matplotlib'), pg.colormap.get('BuPu', source='matplotlib'),
                     pg.colormap.get('RdPu', source='matplotlib'), pg.colormap.get('PuBu', source='matplotlib'),
                     pg.colormap.get('YlGnBu', source='matplotlib'), pg.colormap.get('PuBuGn', source='matplotlib'),
                     pg.colormap.get('BuGn', source='matplotlib'), pg.colormap.get('YlGn', source='matplotlib')],
                 'Sequential (2)': [
                     pg.colormap.get('binary', source='matplotlib'), pg.colormap.get('gist_yarg', source='matplotlib'),
                     pg.colormap.get('gist_gray', source='matplotlib'), pg.colormap.get('gray', source='matplotlib'),
                     pg.colormap.get('bone', source='matplotlib'), pg.colormap.get('pink', source='matplotlib'),
                     pg.colormap.get('spring', source='matplotlib'), pg.colormap.get('summer', source='matplotlib'),
                     pg.colormap.get('autumn', source='matplotlib'), pg.colormap.get('winter', source='matplotlib'),
                     pg.colormap.get('cool', source='matplotlib'), pg.colormap.get('Wistia', source='matplotlib'),
                     pg.colormap.get('hot', source='matplotlib'), pg.colormap.get('afmhot', source='matplotlib'),
                     pg.colormap.get('gist_heat', source='matplotlib'), pg.colormap.get('copper', source='matplotlib')],
                 'Diverging': [
                     pg.colormap.get('PiYG', source='matplotlib'), pg.colormap.get('PRGn', source='matplotlib'),
                     pg.colormap.get('BrBG', source='matplotlib'), pg.colormap.get('PuOr', source='matplotlib'),
                     pg.colormap.get('RdGy', source='matplotlib'), pg.colormap.get('RdBu', source='matplotlib'),
                     pg.colormap.get('RdYlBu', source='matplotlib'), pg.colormap.get('RdYlGn', source='matplotlib'),
                     pg.colormap.get('Spectral', source='matplotlib'), pg.colormap.get('coolwarm', source='matplotlib'),
                     pg.colormap.get('bwr', source='matplotlib'), pg.colormap.get('seismic', source='matplotlib')],
                 'Cyclic': [
                     pg.colormap.get('twilight', source='matplotlib'), pg.colormap.get('twilight_shifted', source='matplotlib'),
                     pg.colormap.get('hsv', source='matplotlib')],
                 'Qualitative': [
                     pg.colormap.get('Pastel1', source='matplotlib'), pg.colormap.get('Pastel2', source='matplotlib'),
                     pg.colormap.get('Paired', source='matplotlib'), pg.colormap.get('Accent',source='matplotlib'),
                     pg.colormap.get('Dark2', source='matplotlib'), pg.colormap.get('Set1', source='matplotlib'),
                     pg.colormap.get('Set2', source='matplotlib'), pg.colormap.get('Set3', source='matplotlib'),
                     pg.colormap.get('tab10', source='matplotlib'), pg.colormap.get('tab20', source='matplotlib'),
                     pg.colormap.get('tab20b', source='matplotlib'), pg.colormap.get('tab20c', source='matplotlib')],
                 'Miscellaneous': [
                     pg.colormap.get('flag', source='matplotlib'), pg.colormap.get('prism', source='matplotlib'),
                     pg.colormap.get('ocean', source='matplotlib'), pg.colormap.get('gist_earth', source='matplotlib'),
                     pg.colormap.get('terrain', source='matplotlib'), pg.colormap.get('gist_stern', source='matplotlib'),
                     pg.colormap.get('gnuplot', source='matplotlib'), pg.colormap.get('gnuplot2', source='matplotlib'),
                     pg.colormap.get('CMRmap', source='matplotlib'), pg.colormap.get('cubehelix', source='matplotlib'),
                     pg.colormap.get('brg', source='matplotlib'),
                     pg.colormap.get('gist_rainbow', source='matplotlib'), pg.colormap.get('rainbow', source='matplotlib'),
                     pg.colormap.get('jet', source='matplotlib'),pg.colormap.get('turbo', source='matplotlib'),
                     pg.colormap.get('nipy_spectral', source='matplotlib'), pg.colormap.get('gist_ncar', source='matplotlib')]}
    colormap_dict_cm = {
