...
class myPlaneFitWin(FramelessWindow, Ui_PlaneFitWindow):
    ...
    def get_plane_fit(self, x, y, z):
        """ fit plane with whole image """
        # only works for square data
    ...
    def init_data(self, data):
        ...
        # file = 'D:/Code\\2022oct/11102208.nstm'
    ...
    def closeEvent(self, a0: QtGui.QCloseEvent) -> None:
        ...
        self.pts.movePoint(self.pts.getHandles()[0], [5, 5])
        self.pts.movePoint(self.pts.getHandles()[1], [10, 10])
        self.pts.movePoint(self.pts.getHandles()[2], [5, 10])
        self.pts.movePoint(self.pts.getHandles()[3], [10, 5])
        a0.accept()
